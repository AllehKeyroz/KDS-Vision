...
import { PlusCircle, Loader2, MoreVertical, Edit, Trash2, FileText } from "lucide-react";
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap justify-between items-center gap-4">
                 <div>
                    <h1 className="text-3xl font-bold tracking-tight font-headline">Propostas Comerciais</h1>
                    <p className="text-muted-foreground">Crie e gerencie as propostas para seus clientes.</p>
                </div>
